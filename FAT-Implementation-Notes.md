---
layout: default
title: "FAT Implementation Notes"
categories:
  - "File Systems"

redirect_from:
  - "/index.php/FAT_Implementation_Notes"
  - "/wiki/FAT_Implementation_Notes"

last_modified: 2009-02-04
---

NOTE: This is copied from the skins_fat.txt file from [TSK](/The-Sleuth-Kit/).  It needs work to be updated and integrated into the Wiki.

               
# Introduction
This document contains information on the implementation of the    
[FAT](/FAT/) file system in [The Sleuth Kit](/The-Sleuth-Kit/).  The Sleuth Kit is based on the  
...
# Disk Unit Addressing
FAT saves file content in clusters.  A [cluster](/Cluster/) is a grouping of
...
the root directory is given the value of 2.  The first 32-bytes of the first sector in the data area
