---
layout: default
title: "Database v7.2 Schema"
categories:
  - "Development"

redirect_from:
  - "/index.php/Database_v7.2_Schema"
  - "/wiki/Database_v7.2_Schema"

last_modified: 2019-07-19
---

This page outlines version 7.2 of the [TSK](/The-Sleuth-Kit/) database schema (see [TSK Schema Versioning](/TSK-Schema-Versioning/) for details on version numbers).  It is used in Autopsy 4.6.0 and beyond.  The database is made by using the [tsk_loaddb](/tsk_loaddb/) command line tool or the equivalent library-level methods.  
