---
layout: default
title: "SQLite Database v3 Schema"
categories:
  - "Development"

redirect_from:
  - "/index.php/SQLite_Database_v3_Schema"
  - "/wiki/SQLite_Database_v3_Schema"

last_modified: 2015-04-27
---

This page outlines version 3 of the [TSK](/The-Sleuth-Kit/) SQLite schema.  It is used in Autopsy 3.1.0 and beyond.  There is also a page for the [SQLite Database v2 Schema](/SQLite-Database-v2-Schema/). 
...
* *size* - Size of the original image (in bytes) (NEW in V3)
* *md5* - Hash of the image.  Currently, this is populated only if the input image is E01.  (NEW in V3)
* *description* - display name of the image. (NEW in V3)
